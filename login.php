...
<head>
    ...
    <link href="assetscss/sb-admin.css" rel="stylesheet">

</head>

<body>
    
                <img src="assets/images/NPMI.png" style="heigh:200px;width:200px" class="center-block">
                        ...
                        <form role="form" id="login-form">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="User" name="user" type="text" id="user" autofocus>
                                </div>
                                <div class="form-group">
