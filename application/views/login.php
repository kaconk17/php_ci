...
<head>
    ...
    <link href="<?php echo base_url(); ?>assetscss/sb-admin.css" rel="stylesheet">

</head>

<body>
    
                <img src="<?php echo base_url(); ?>assets/images/NPMI.png" style="heigh:200px;width:200px" class="center-block">
            ...
            <div class="col-md-4 col-md-offset-4">
                ...
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" id="login-form" method="post" action="<?php echo base_url('auth/login'); ?>">
                            <fieldset>
